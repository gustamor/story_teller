...
///
/// This exception should be thrown when an authentication process encounters a known error.
/// It provides a clear message describing the error, aiding in error handling and debugging.
class AuthException implements Exception {
  final String message;

  /// Initializes an [AuthException] with an error message [message].
...
class AuthenticationServiceImpl implements AuthenticationService {
  ...
  ///
  /// Returns the email address if a user is currently authenticated, otherwise null.
  /// Throws an [AuthException] if an error occurs while fetching the user's email.
  @override
  String? getUserEmail() {
    try {
  ...
  ///
  /// Attempts to update the display name of the current user with the provided [name].
  /// Throws an [AuthException] if an error occurs during the update process.
  @override
  ...
  /// Retrieves the display name of the current authenticated user.
  ///
  /// Returns the display name of the currently authenticated user.
  /// Throws an [AuthException] if an error occurs while fetching the user's display name.
  @override
